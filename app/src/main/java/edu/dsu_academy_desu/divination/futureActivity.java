...
public class futureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(futureActivity.this, "error", Toast.LENGTH_SHORT).show();
        }
        Button above = (Button)findViewById(R.id.next);
        above.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(futureActivity.this, aboveActivity.class);
