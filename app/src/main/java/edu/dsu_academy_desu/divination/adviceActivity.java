...
public class adviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if(cards.get(0) == "King of Pentacles Inverse")
        {
            ...
            Toast.makeText(adviceActivity.this, "error", Toast.LENGTH_SHORT).show();
        }
        Button below = (Button)findViewById(R.id.next);
        below.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(adviceActivity.this, externalInfluencesActivity.class);
