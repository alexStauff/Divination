...
public class hopesNFearsActivity extends AppCompatActivity {
    public ArrayList<String> cards = new ArrayList<String>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hopes_nfears);
        cards.add("The Fool");
        ...
        else if(cards.get(0) == "King of Pentacles Inverse")
        {
            ...
            Toast.makeText(hopesNFearsActivity.this, "error", Toast.LENGTH_SHORT).show();
        }
        final Button outcome = (Button)findViewById(R.id.next);
        outcome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(hopesNFearsActivity.this, outcomeActivity.class);
