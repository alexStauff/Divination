...
public class outcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(outcomeActivity.this, "error", Toast.LENGTH_SHORT).show();
            TextView error = (TextView)findViewById(R.id.text);
            error.setText(cards.get(0));
        }
        final Button reset = (Button)findViewById(R.id.next);
